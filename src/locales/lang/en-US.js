...
const locale = {
  ...
  // ===== Strategy Mode =====
  'trading-assistant.strategyMode.signal': 'Signal Strategy',
  'trading-assistant.strategyMode.script': 'Script Strategy',
  'trading-assistant.strategyMode.signalDesc': 'Pick a technical indicator + configure trading params, ideal for trend-following strategies',
  'trading-assistant.strategyMode.scriptDesc': 'Write full strategy code, supports Martingale, Grid and other complex strategies',
  'trading-assistant.strategyMode.signalFeature1': 'Select existing indicator',
  'trading-assistant.strategyMode.signalFeature2': 'Visual TP/SL configuration',
  'trading-assistant.strategyMode.signalFeature3': 'Great for trend following',
  'trading-assistant.strategyMode.scriptFeature1': 'Full Python strategy code',
  'trading-assistant.strategyMode.scriptFeature2': 'Martingale / Grid / Arbitrage',
  'trading-assistant.strategyMode.scriptFeature3': 'Full control over trade logic',
  'trading-assistant.selectMode': 'Select Strategy Type',
  'trading-assistant.selectModeHint': 'Choose the strategy development mode that fits your needs',
