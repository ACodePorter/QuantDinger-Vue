...
const locale = {
  ...
  // ===== 策略模式 (Strategy Mode) =====
  'trading-assistant.strategyMode.signal': '信号策略',
  'trading-assistant.strategyMode.script': '脚本策略',
  'trading-assistant.strategyMode.signalDesc': '选择技术指标 + 配置交易参数，适合趋势跟随类策略',
  'trading-assistant.strategyMode.scriptDesc': '编写完整策略代码，支持马丁格尔、网格等复杂策略',
  'trading-assistant.strategyMode.signalFeature1': '选择已有指标',
  'trading-assistant.strategyMode.signalFeature2': '可视化配置止盈止损',
  'trading-assistant.strategyMode.signalFeature3': '适合趋势跟随策略',
  'trading-assistant.strategyMode.scriptFeature1': '完整 Python 策略代码',
  'trading-assistant.strategyMode.scriptFeature2': '支持马丁/网格/套利等',
  'trading-assistant.strategyMode.scriptFeature3': '自由控制交易逻辑',
  'trading-assistant.selectMode': '选择策略类型',
  'trading-assistant.selectModeHint': '选择适合您的策略开发模式',
